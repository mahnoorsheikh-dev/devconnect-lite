      ...
      <div className="mx-auto max-w-7xl px-4 py-6 md:px-6 lg:px-8">
        <div className="grid gap-6 xl:grid-cols-[260px_minmax(0,1fr)_280px]">
          <aside className="space-y-6 xl:sticky xl:top-24 xl:h-fit">
            <div className="rounded-[28px] border border-slate-800 bg-slate-900/80 p-5 shadow-[0_20px_50px_rgba(15,23,42,0.45)]">
          ...
          <main className="space-y-6">
            ...
            {error && (
              <div className="rounded-[28px] border border-red-500/30 bg-red-950/40 p-4 text-red-200 shadow-[0_20px_50px_rgba(127,29,29,0.25)]">
                {error}
              </div>
            )}
          ...
          <aside className="space-y-6 xl:sticky xl:top-24 xl:h-fit">
            <div className="rounded-[28px] border border-slate-800 bg-slate-900/80 p-5 shadow-[0_20px_50px_rgba(15,23,42,0.45)]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-400">Trending</p>
            ...
            <div className="rounded-[28px] border border-slate-800 bg-slate-900/80 p-5 shadow-[0_20px_50px_rgba(15,23,42,0.45)]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-400">Quick Check</p>
