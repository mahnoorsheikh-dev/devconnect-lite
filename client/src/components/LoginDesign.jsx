        ...
        <div className="grid md:grid-cols-2">
          <div className="flex flex-col justify-between bg-linear-to-br from-indigo-600 via-violet-600 to-purple-700 p-8 md:p-12">
            <div>
              ...
              <p className="mt-4 max-w-md text-base text-indigo-100/90 md:text-lg">
                Share ideas, discover projects, and connect with developers building what’s next.
              </p>
            </div>
            ...
            <div className="mt-10 space-y-4 text-sm text-indigo-50">
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 p-3">
                ...
                <span>Join conversations with your community</span>
              </div>
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 p-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/20 text-lg">🚀</div>
                <span>Discover new opportunities and projects</span>
              </div>
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 p-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/20 text-lg">🤝</div>
                <span>Build stronger professional connections</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center bg-slate-950 p-6 md:p-12">
            <div className="w-full max-w-md">
              <div className="mb-8">
                <p className="text-sm font-medium uppercase tracking-[0.2em] text-indigo-300">Sign in</p>
                <h2 className="mt-2 text-3xl font-bold text-white">Access your account</h2>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div className="flex items-center justify-between text-sm text-slate-400">
                  ...
                  <button type="button" className="text-indigo-300 transition hover:text-indigo-200">
                    Forgot password?
                  </button>
                </div>
