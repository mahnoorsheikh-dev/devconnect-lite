  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-100">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        {loadingPost ? (
          <div className="rounded-[28px] border border-slate-800 bg-slate-900/80 p-8 text-center text-slate-300 shadow-[0_20px_60px_rgba(15,23,42,0.5)]">
          ...
          <div className="space-y-6">
            <div className="rounded-[30px] border border-slate-800 bg-slate-900/80 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.65)] backdrop-blur-sm">
              <div className="mb-5 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-indigo-500 to-violet-500 text-lg font-bold text-white">
                ...
                <span className="rounded-full border border-indigo-500/30 bg-indigo-500/10 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.2em] text-indigo-200">
                  Post
                </span>
              </div>
            ...
            <div className="rounded-[30px] border border-slate-800 bg-slate-900/80 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.5)]">
            ...
            {error && (
              <div className="rounded-2xl border border-red-700/50 bg-red-950/40 p-4 text-red-200">
                {error}
              </div>
            )}
          </div>
